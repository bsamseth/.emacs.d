...
\usepackage[backend=biber, sorting=none]{biblatex}
        \addbibresource{/home/bendik/bibliography/database.bib}
\usepackage{color}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsthm}
...
\usepackage{siunitx}
	...
	\sisetup{exponent-product = \cdot}	% Prikk som multiplikasjonstegn (i stedet for kryss).
 	...
 	\sisetup{separate-uncertainty = true} 	% Pluss-minus-form på
        ...
        \sisetup{% # bruk norske ord i numrange og numlist + magi for
                 % at alt fungerer i og utenfor matte
          range-phrase = {\ \linebreak[0]\text{til}\ \nolinebreak},
          list-separator = {\text{, }},
          list-final-separator = {,\ \linebreak[0]\text{og }},
...
\title{Obligatorisk oppgave (>>>oblignr<<<)}
\date{\today}
\address{b.samseth@gmail.com}
