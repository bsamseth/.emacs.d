...
(custom-set-variables
 ...
 '(company-backends
   (quote
    (company-elisp company-bbdb company-nxml company-css company-eclim company-semantic company-clang company-xcode company-cmake company-capf
		   ...
		   company-oddmuse company-files company-dabbrev company-math-symbols-latex company-latex-commands)))
 '(company-idle-delay 0)
 '(company-minimum-prefix-length 1)
 '(custom-enabled-themes (quote (lush)))
 '(custom-safe-themes
   (quote
    ("1ba463f6ac329a56b38ae6ac8ca67c8684c060e9a6ba05584c90c4bffc8046c3" "1636c901ca6cedd80bea5d97b59238ee9467b712a2cf39c8bb1cd3a49cc6f0ba" "4cefd96dbec5c775b1b396989d695d6b1cd4961f6ad78595f4ef45d8805a88da" default)))
 '(ecb-debug-mode t)
 '(ecb-layout-window-sizes
   (quote
    (("left3"
      (ecb-directories-buffer-name 0.19047619047619047 . 0.35135135135135137)
      (ecb-sources-buffer-name 0.19047619047619047 . 0.2702702702702703)
      (ecb-methods-buffer-name 0.19047619047619047 . 0.35135135135135137)))))
 ...
 '(org-agenda-custom-commands
   (quote
    (("D" "Daily agenda"
      ...
      nil)
     ("U" "Unscheduled tasks" tags "-SCHEDULED={.+}/!+TODO" nil)
     ("W" "Weekly agenda (8 days starting today)"
      ((agenda ""
 ...
 '(org-capture-templates
   (quote
    (("t" "Todo" entry
      (file+headline "~/org/personlig.org" "GTD")
      "* TODO %? %i %a" :clock-resume t)
     ("k" "Kalender" entry
      (file+headline "~/org/personlig.org" "Kalender")
      "* APPT %?" :clock-resume t)
     ("s" "Samtale" entry
      (file+headline "~/org/personlig.org" "Samtaler")
 ...
 '(org-todo-keyword-faces
   (quote
    (("CANCELED" :foreground "green")
     ("DONE" . "green")
     ("WAIT" . "cyan")
     ("TODO" :foreground "red" :weight bold))))
 '(org-todo-keywords
   (quote
    ((sequence "TODO(t)" "WAIT(w@/!)" "APPT(a)" "|" "DONE(d!)" "DELEGATED(g!)" "CANCELED(c@)"))))
 '(package-archives
   (quote
 ...
 '(yas-snippet-dirs
   (quote
    ("/home/bendik/.emacs.d/plugins/yasnippet/snippets")) nil (yasnippet)))
(custom-set-faces
